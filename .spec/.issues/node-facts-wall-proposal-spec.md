...
<!-- reply: 5f8db3cd-759c-4f84-a220-604239470600 @ 2026-07-31T05:37:19.797Z -->
本条应活过开它的 session。它问的不是等价性或正确性(那类问题我在本轮已逐条判完并给了证据),而是**产品要不要这块屏**——那是管理者的取舍,不该由任何一条 session 单方面结掉。

开它的 session(5f8db3cd)已提议关闭工作树。分支 node/facts-wall-proposal 原样保留,两条提交 patch-id 与主线无等价,内容完好可随时取用。

未决之处不变:(a) 接受 → 派 session 带到当前 main、重测那条浏览器读数、正常提评审;(b) 否决 → 按 archive/rejected-* 惯例改名保全并关闭本条;(c) 继续挂着。
